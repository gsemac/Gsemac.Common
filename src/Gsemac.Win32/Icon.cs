...
namespace Gsemac.Win32 {
    ...
    public sealed class Icon :
        ...
        public static Icon FromFilePath(string fileExtension, IconSize iconSize) {
            ...
            Shell32.SHGetFileInfo(fileExtension, FILE_ATTRIBUTE_NORMAL, ref shInfo, Marshal.SizeOf(shInfo), SHGFI_ICON | (int)iconSize | SHGFI_USEFILEATTRIBUTES);
