...
namespace Gsemac.Net {
    ...
    public static class HttpWebRequestUtilities {
        ...
        public static WebResponse FollowHttpRedirects(IHttpWebRequest httpWebRequest, IHttpWebRequestFactory httpWebRequestFactory, int maximumRedirections = defaultMaximumRedirections) {
        ...
        public static WebResponse FollowHttpRedirects(HttpWebRequest httpWebRequest, int maximumRedirections = defaultMaximumRedirections) {

            return FollowHttpRedirects(new HttpWebRequestWrapper(httpWebRequest), new HttpWebRequestFactory(), maximumRedirections);
