...
namespace Gsemac.IO.Compression.SevenZip {
    ...
    internal sealed class SevenZipProcessArchive :
        ...
        public SevenZipProcessArchive(Stream stream, string sevenZipDirectoryPath, IFileFormat archiveFormat, IArchiveOptions options) :
            base(options) {
        ...
        public override void ExtractEntry(IArchiveEntry entry, Stream outputStream) {
            ...
            if (entry is NewArchiveEntry newArchiveEntry) {
                ...
                ICommandLineArgumentsBuilder argumentsBuilder = new ProcessArgumentsBuilder()
                    .WithArgument("e")
            ...
            if (newEntries.Any()) {
                ...
                try {
                    ...
                    if (filesToAdd.Any()) {
                        ...
                        argumentsBuilder = new ProcessArgumentsBuilder()
