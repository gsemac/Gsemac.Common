...
namespace Gsemac.IO.Compression.WinRar {
    ...
    internal sealed class WinRarProcessArchive :
        ...
        public WinRarProcessArchive(Stream stream, string winrarDirectoryPath, IFileFormat archiveFormat, IArchiveOptions options) :
            base(options) {
        ...
        public override void ExtractEntry(IArchiveEntry entry, Stream outputStream) {
            ...
            if (entry is NewArchiveEntry newArchiveEntry) {
                ...
                processStartInfo.Arguments = new ProcessArgumentsBuilder()
                    .WithArgument("p")
