...
namespace Gsemac.Polyfills.System.Collections.ObjectModel {
    ...
    public class ReadOnlyCollection<T> :
        ...
        /// <summary>
        /// Copies the entire <see cref="ReadOnlyCollection{T}"/> to a compatible one-dimensional <see cref="Array"/>, starting at the specified index of the target array.
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination of the elements copied from <see cref="ReadOnlyCollection{T}"/>. The <see cref="Array"/> must have zero-based indexing.</param>
