...
namespace Gsemac.Net.Curl {
    ...
    public class CurlProcessStream :
        ProcessStream {

        // Public members

        public CurlProcessStream(string filename, IProcessStreamOptions options = null) :
            base(filename, options ?? ProcessStreamOptions.Default) { }
        public CurlProcessStream(string filename, string arguments, IProcessStreamOptions options = null) :
            base(filename, arguments, options ?? ProcessStreamOptions.Default) { }
        public CurlProcessStream(ProcessStartInfo startInfo, IProcessStreamOptions options = null) :
